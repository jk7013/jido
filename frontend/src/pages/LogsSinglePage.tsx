...
const LogsSinglePage: React.FC = () => {
  ...
  const [selectedStep, setSelectedStep] = useState<string | null>(step);
    ...
    <div>
      ...
      <div className="container">
        <div className="align-right">
          <Link to="/results/single" className="ghost">View Results</Link>
        ...
        <main>
          <div className="panel">
            <div className="inner">
              <div className="title">Single Logs</div>
              ...
              {/* 워터폴 */}
              <div className="waterfall" style={{ marginBottom: '16px' }}>
                <div className="title">실행 단계</div>
